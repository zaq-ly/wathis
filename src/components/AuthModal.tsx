...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    ...
    const initGis = () => {
      ...
      if (window.google?.accounts?.id && googleBtnRef.current) {
        ...
        retryCount++;
        timerId = setTimeout(initGis, 100);
      }
    };
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm sm:max-w-md bg-card border border-black/10 dark:border-white/10 rounded-[2rem] shadow-xl p-6 sm:p-10 relative transition-colors"
      ...
      >
        ...
        <div className="space-y-3 flex flex-col items-center w-full">
          ...
          <div className="w-full flex justify-center px-4 py-1 overflow-hidden">
            <div
              ref={googleBtnRef}
              className={`min-h-[44px] w-full flex items-center justify-center [&>*:not(:first-child)]:hidden transition-all ${
